...
var DocNavIcon = function (_a) {
    var color = _a.color, size = _a.size, reverse = _a.reverse;
    return (react_1.default.createElement("svg", { width: size || "100%", height: size || "100%", style: { transform: "".concat(reverse ? "rotate(180deg)" : "") }, id: "arrow_left", version: "1.1", viewBox: "0 0 32 32", xmlSpace: "preserve" },
